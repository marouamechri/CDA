...
public class RoleControllerUnitTest {
    ...
    @Test
    public void testAttachRoleToUser() throws UserNotFoundException, RoleNotFoundException {
        //Defining the mock with Mockito
        User user = new User();
        user.setId(1);
    ...
    @Test
    public void testAttachRoleNotFoundToUser() throws UserNotFoundException, RoleNotFoundException {
        //Defining the mock with Mockito
        User user = new User();
        user.setId(1);
        user.setUsername("UserTest");
        ...
        Mockito.when(mockUserService.get(ArgumentMatchers.anyInt())).thenReturn(user);
       Mockito.when(mockRoleService.get(ArgumentMatchers.anyInt())).thenReturn(null);
    ...
    @Test
    public void testDetachRoleToUser() throws UserNotFoundException, RoleNotFoundException {
        //Defining the mock with Mockito
        User user = new User();
        user.setId(1);
        user.setUsername("UserTest");
    ...
    @Test
    public void testDetachRoleToUserNotFound() throws UserNotFoundException, RoleNotFoundException {
        //Defining the mock with Mockito
        Role role =new Role();
        role.setId(1);
        role.setName("RoleTest");
