...
public interface DoctorUserController {
    ...
    ResponseEntity<DoctorUser> update(@PathVariable Long idDoctor, @PathVariable Long idSpace, @Valid @RequestBody DoctorUserDto dto, Principal principal , @RequestParam String  attach, @RequestParam String detach) throws URISyntaxException, DoctorUserNotFoundException, SpaceNotFoundException, DoctorUserExistException;

    @DeleteMapping("/{idSpace}/subject/{idDoctor}")
